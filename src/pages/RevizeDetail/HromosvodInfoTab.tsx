        ...
        <div className="p-4">
          <div className={TW.grid2}>
            <Field label="Třída LPS">
              <select className={TW.selectFull} value={formData.hromosvodTridaLps || ''} onChange={(e) => setFormData({ ...formData, hromosvodTridaLps: e.target.value as any })}>
            ...
            <Field label="Typ ochrany">
              <select className={TW.selectFull} value={formData.hromosvodTypOchrany || ''} onChange={(e) => setFormData({ ...formData, hromosvodTypOchrany: e.target.value as any })}>
                <option value="">-- Vyberte --</option>
        ...
        <div className="p-4">
          <div className={TW.grid3}>
            ...
            <Field label="Lhůta platnosti">
              <select className={TW.select} value={String(formData.termin || 48)} onChange={(e) => setFormData({ ...formData, termin: parseInt(e.target.value) })}>
