...
export const createRevizniZpravaTemplate = (): DesignerTemplate => {
  ...
  const page2Widgets: Widget[] = [
    ...
    // Sekce: Rozvaděče s okruhy (repeater)
    createWidget({
      type: 'text',
      name: 'Nadpis rozvaděče',
      content: '2. Rozvaděče a jejich okruhy',
      x: 15,
      y: 65,
      width: 180,
      height: 12,
    ...
    // Repeater pro rozvaděče - pro každý rozvaděč se zopakuje blok
    createWidget({
      type: 'repeater',
      name: 'Rozvaděče s okruhy',
      content: '',
      x: 15,
      y: 78,
      width: 180,
      height: 85, // Výška jedné instance (bude se opakovat)
      zone: 'content',
      pageId: page2Id,
      zIndex: 8,
      autoGrow: true,
      ...
      repeaterConfig: {
        type: 'rozvadece',
        gap: 10, // Mezera mezi rozvaděči v mm
        direction: 'vertical',
        showSeparator: true,
        separatorStyle: { borderWidth: 1, borderColor: '#e5e7eb', borderStyle: 'dashed' },
        template: [
          // Nadpis rozvaděče
          {
            id: 'rozvadec_header',
            ...
            style: { fontSize: 12, fontWeight: 'bold', color: '#1e40af' },
          },
          // Info box
          {
            ...
            width: 180,
            height: 18,
            style: { borderWidth: 1, borderColor: '#e5e7eb', borderStyle: 'solid', backgroundColor: '#f9fafb', borderRadius: 2 },
          },
          // Umístění
          {
          ...
          // Poznámka k rozvaděči
          {
            id: 'rozvadec_poznamka_label',
            type: 'text',
            name: 'Poznámka label',
            relativeX: 2,
            relativeY: 18,
