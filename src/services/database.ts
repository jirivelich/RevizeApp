  ...
  getDefaultSablona(): Omit<Sablona, 'id' | 'createdAt' | 'updatedAt'> {
    return {
      ...
      sekce: [
        ...
        { id: 'rozsah-podklady', nazev: 'Rozsah revize a podklady', enabled: true, poradi: 3 },
        { id: 'provedene-ukony', nazev: 'Provedené úkony', enabled: true, poradi: 4 },
        { id: 'vyhodnoceni-predchozich', nazev: 'Vyhodnocení předchozích revizí', enabled: true, poradi: 5 },
        { id: 'rozvadece', nazev: 'Rozvaděče a okruhy', enabled: true, poradi: 6 },
        { id: 'mereni', nazev: 'Výsledky měření', enabled: true, poradi: 7 },
        { id: 'mistnosti', nazev: 'Místnosti a zařízení', enabled: true, poradi: 8 },
        { id: 'pristroje', nazev: 'Použité měřicí přístroje', enabled: true, poradi: 9 },
        { id: 'zaver', nazev: 'Závěr revize', enabled: true, poradi: 10 },
        { id: 'podpisy', nazev: 'Podpisy', enabled: true, poradi: 11 },
        { id: 'zavady', nazev: 'Závady (příloha)', enabled: true, poradi: 12 },
      ],
      sloupceOkruhu: [
